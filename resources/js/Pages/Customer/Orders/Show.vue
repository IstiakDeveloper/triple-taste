    ...
    <div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
          ...
          <dl class="mt-4 space-y-4">
            ...
            <div>
              ...
              <dd class="mt-1 text-sm text-gray-900 dark:text-gray-100">{{ deliveryEta || 'Not available' }}</dd>
            </div>
          </dl>
        </div>
      ...
      <div class="mt-6 bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
        <div class="sm:flex sm:items-center sm:justify-between">
          ...
          <div class="mt-4 sm:mt-0">
            <button class="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:focus:ring-offset-gray-800">
      ...
      <div v-if="order.status === 'completed'" class="mt-6 bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
        <div class="sm:flex sm:items-center sm:justify-between">
          ...
          <div class="mt-4 sm:mt-0">
            <button class="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 dark:focus:ring-offset-gray-800">
